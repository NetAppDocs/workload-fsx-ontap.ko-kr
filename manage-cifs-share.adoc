...
summary: Workload Factory에서 볼륨의 SMB 또는 CIFS 공유를 관리하는 방법에는 공유 생성, 사용자 및 그룹 액세스 권한 설정, 그리고 삭제가 포함됩니다. 
---
= NetApp Workload Factory에서 볼륨의 SMB/CIFS 공유 관리
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* SMB/CIFS 공유를 관리하려면 링크를 연결해야 합니다. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["기존 링크를 연결하는 방법이나 새 링크를 만들고 연결하는 방법을 알아보세요."^]. 링크가 연결되면 이 작업으로 돌아오십시오.
