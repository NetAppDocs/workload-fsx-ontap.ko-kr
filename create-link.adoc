...
. 메뉴 image:workloads-menu-icon.png["햄버거 메뉴 아이콘은 스토리지, EDA, AI, 데이터베이스, VMware 및 관리와 같은 워크로드로 이동하는 데 사용됩니다."]를 선택한 다음 *관리*를 선택하십시오.
. 관리 메뉴에서 *링크*를 선택합니다.
...
.관련 정보
link:links-overview.html#when-a-link-is-required["링크에 대해 자세히 알아보세요"].
