...
* 복제된 볼륨을 분할하려면 링크를 연결해야 합니다. link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["기존 링크를 연결하는 방법이나 새 링크를 만들고 연결하는 방법을 알아보세요."^]. 링크가 연결되면 이 작업으로 돌아오십시오.
...
. 분할할 복제된 볼륨이 있는 볼륨의 작업 메뉴를 선택합니다.
