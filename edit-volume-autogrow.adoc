...
summary: 볼륨 자동 증가를 활성화하면 Workload Factory에서 볼륨 용량을 관리하게 됩니다.  언제든지 비활성화할 수 있습니다. 
---
= Workload Factory에서 볼륨 자동 증가 활성화
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
[role="lead"]
볼륨 자동 증가를 활성화하면 Workload Factory에서 볼륨 용량을 관리하게 됩니다.  언제든지 비활성화할 수 있습니다.

선택적으로 언제든지 볼륨의 볼륨 용량을 수동으로 늘릴 수 있습니다.link:adjust-volume-capacity.html["볼륨 용량 조절 기능"] .
...
. 볼륨 탭에서 수정하려는 볼륨에 대한 작업 메뉴를 선택합니다.
