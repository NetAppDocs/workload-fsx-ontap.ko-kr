...
summary: NetApp Workload Factory에서 온프레미스 ONTAP 데이터를 검색하고 복제하여 AI 지식 기반을 강화하는 데 사용할 수 있습니다. 
---
...
[role="lead"]
NetApp Workload Factory에서 온프레미스 ONTAP 데이터를 검색하고 복제하여 AI 지식 기반을 강화하는 데 사용할 수 있습니다.
